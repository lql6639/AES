 ...
 * @example
 * AES_CFB_Encryption (content)
 */

function AES_CFB_Encryption (content) {
 ...
 * @example
 * AES_CFB_Decryption (encryptedHex)
 */

function AES_CFB_Decryption (encryptedHex) {
...
module.exports = { AES_CFB_Encryption, AES_CFB_Decryption }
